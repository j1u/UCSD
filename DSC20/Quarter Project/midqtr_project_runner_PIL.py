...
def image_processing_test_examples():
    ...
    # grayscale and save
    gs_dsc20_img = IP.grayscale(dsc20_img)
    img_save("img/out/dsc20_gs.png", gs_dsc20_img)

    # clear channel and save
    clear_dsc20_img = IP.clear_channel(dsc20_img, 0)
    img_save("img/out/dsc20_clear_channel.png", clear_dsc20_img)

    # crop and save
    crop_dsc20_img = IP.crop(dsc20_img, 50, 75, (75, 50))
    img_save("img/out/dsc20_crop_channel1.png", crop_dsc20_img)
    crop_dsc20_img = IP.crop(dsc20_img, 100, 50, (100, 150))
    img_save("img/out/dsc20_crop_channel2.png", crop_dsc20_img)
    ...
    # chroma key with a background image and save
    bg_img = img_read("img/blue_gradient.png")
    chroma_pink_dsc20_img = IP.chroma_key(dsc20_img, bg_img, (255, 205, 210))
    img_save("img/out/dsc20_chroma_pink.png", chroma_pink_dsc20_img)
